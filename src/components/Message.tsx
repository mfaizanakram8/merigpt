...
// Include 'system' in the role type
interface MessageProps {
  role: "user" | "assistant" | "system"; // Expanded to include "system"
  content: string | null; // Content of the message
}

interface Props {
  message: MessageProps; // Props structure
}
  ...
  return (
    <div
      className={`group w-full text-gray-800 dark:text-gray-100 border-b border-black/10 dark:border-gray-900/50 ${
        isUser ? "dark:bg-gray-800" : isSystem ? "bg-gray-200" : "bg-gray-50 dark:bg-[#444654]"
      }`}
    >
